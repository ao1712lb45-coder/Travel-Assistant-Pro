(function (root, factory) {
  ...
  const PREFS = [
    ...
    ['年輕人體驗',/年輕人|體驗多|刺激|夜生活|自由活動/],['跟團',/跟團|團體旅遊/],['自由行',/自由行/],['機加酒',/機加酒|機票加酒店|機票\+飯店/]
  ];
