...
(function () {
  ...
  nav.innerHTML='<div class="workspace-brand"><strong>V2.2 資料安全與雲端穩定版</strong><span>行程解析、行銷素材、雲端 CRM、同步狀態與安全備份。</span></div>';
