...
(function(global,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;global.TravelBulkItineraryImport=api;})(typeof window!=='undefined'?window:globalThis,function(){
  ...
  function install(){
    ...
    document.getElementById('clearBulkImport').onclick=()=>{document.getElementById('bulkItineraryInput').value='';document.getElementById('bulkImportProgress').className='status';document.getElementById('bulkProgressBox').style.display='none'};
